...
fig, ax = plt.subplots(figsize=(12,8))
daily_case_bar(us_covid_total, a, b, '#FBC00C', 'COVID-19 Daily Cases', 'United States', ax)
daily_case_bar(canada_covid_total, c, d, '#A62205', 'COVID-19 Daily Cases', 'Canada', ax)
daily_case_bar(aus_covid, e, f, '#1A89F4', 'COVID-19 Daily Cases', 'Australia', ax)
daily_case_bar(nz_covid_total, x, y, 'black', 'COVID-19 Daily Cases', 'New Zealand', ax)
...
fig, ax = plt.subplots(figsize=(12,8))
daily_case_bar(co_covid, g, h, 'm', 'COVID-19 Daily Cases', 'Colorado', ax)
daily_case_bar(nz_covid_total, x, y, 'black', 'COVID-19 Daily Cases Comparison', 'New Zealand', ax)
